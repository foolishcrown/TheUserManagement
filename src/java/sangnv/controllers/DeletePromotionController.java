...
public class DeletePromotionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (proList.getProList().contains(dto)) {
                proList.removeList(dto);
                request.setAttribute("MSG", "Deleted Success");
                session.setAttribute("PROLIST", proList);
            }else{
                request.setAttribute("INVALID", "Promotion item not found in list.");
            }
            
        } catch (Exception e) {
            log("Error at Delete Promotion Controller : "+ e.getMessage());
        }finally {

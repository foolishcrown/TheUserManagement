...
public class ConfirmPromotionController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (proList != null) {
                List<PromotionDTO> result = proList.getProList();
                PromotionDAO dao  =new  PromotionDAO();
                int[] results = dao.insertProList(result);
                System.out.println("Count line inserted : " + results.length);
                request.setAttribute("MSG", "Saved to Database");
                session.removeAttribute("PROLIST");
            }else{
                request.setAttribute("INVALID", "Can't find your promotion list");
            }
            
        } catch (Exception e) {
            log("Error at ConfirmDB Controller : " + e.getMessage());
        }finally {
